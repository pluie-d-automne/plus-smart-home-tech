...
import collector.service.handler.KafkaClient;
...
public class CollectorController {
    ...
    public void collectSensorEvent(@Valid @RequestBody SensorEvent event) {
        ...
        ProducerRecord<String, SpecificRecordBase> record = new ProducerRecord<>(KafkaTopics.TELEMETRY_SENSORS_TOPIC, event.getHubId(), eventAvro);
    ...
    public void collectHubEvent(@Valid @RequestBody HubEvent event) {
        ...
        HubEventAvro eventAvro = HubEventAvro.newBuilder()
                ...
                .setPayload(payload)
                .build();
        ProducerRecord<String, SpecificRecordBase> record = new ProducerRecord<>(KafkaTopics.TELEMETRY_HUBS_TOPIC, event.getHubId(), eventAvro);
        client.getProducer().send(record);
    }
